...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT( //base
        ...
        LSFT_T(KC_Z), KC_X, KC_C, KC_V, KC_B,           KC_SLSH, KC_N, KC_M, KC_COMM, RSFT_T(KC_DOT),
        KC_LCTL,     KC_LALT, LT(3,KC_SPACE),               LT(2,KC_BSPC), KC_LGUI, KC_RCTL
    ),
    [2] = LAYOUT( //function keys
        KC_TRNS, KC_F7, KC_F8, KC_F9, KC_F12,               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, QK_BOOT,
        KC_TRNS, KC_F4, KC_F5, KC_F6, KC_F11,               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, QK_MAKE,
    ...
    [3] = LAYOUT( //numpad and symbols
        ...
        LSFT_T(KC_PSLS), KC_1, KC_2, KC_3, KC_PDOT,     UM(DEG), UP(UE_lC,UE_uC), KC_NUBS, KC_LBRC,    KC_RBRC,
        KC_TRNS,                  KC_TRNS, KC_TRNS,         KC_TRNS, KC_TRNS, KC_TRNS
    ),
    [4] = LAYOUT( //navigation
        ...
        KC_LSFT, KC_F13,  KC_F14,  KC_F15,  KC_TRNS,    KC_TRNS, KC_PGDN, C(KC_LEFT), KC_TRNS, C(KC_RIGHT),
        KC_TRNS,                   KC_TRNS, KC_DEL,         KC_ENT,              KC_TRNS, KC_TRNS
    )
};
