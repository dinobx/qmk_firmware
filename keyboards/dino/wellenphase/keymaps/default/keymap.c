...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT( //base
        ...
        KC_LCTL, KC_LGUI, KC_LALT, LT(2,KC_SPACE), LT(2,KC_SPACE), /*2.25Space Position*/  LT(1,KC_BSPC), KC_DEL,    KC_NO, KC_RCTL
    ),
    ...
    [3] = LAYOUT( //navigation
        ...
        KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS,                 KC_ENT,  KC_TRNS,                          KC_TRNS, KC_TRNS
    )
};
